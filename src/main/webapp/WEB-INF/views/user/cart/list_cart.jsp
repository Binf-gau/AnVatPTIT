...
<div class="row">
	...
	<table class="table table-bordered table-condensed">
              <thead>
                <tr>
                  ...
                  <th>Tên sản phẩm</th>
                  <th>Giá bán</th>
                  <th colspan="2">Chỉnh sửa số lượng </th>
                  <th>Xóa </th>
                  <th>Tổng tiền</th>
				</tr>
              </thead>
              <tbody>
				...
				<c:forEach var="item" items="${ Cart }">
					<tr>
	                  ...
	                  <td>
						<input type="number" min="1" max="100" class="span1" style="max-width:34px" placeholder="1" id="quanty-cart-${ item.key }" size="16" type="text" value="${ item.value.quanty }">
					  </td>
	                  <td>
	...
	<a href="<c:url value="/"/>" class="shopBtn btn-large"><span class="icon-arrow-left"></span> Tiếp tục mua sắm </a>
