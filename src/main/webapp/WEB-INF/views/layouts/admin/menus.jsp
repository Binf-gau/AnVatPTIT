	...
	<div class="sidebar-menu">
	   ...
	   <div class="menu">
	       <ul id="menu">
	           ...
	           <li id="menu-academico" ><a href="#"><i class="fa fa-envelope nav_icon"></i><span>Tin nhắn</span><div class="clearfix"></div></a></li>
	           ...
	           <li id="menu-academico"><a href="#"><i class="fa fa-cogs" aria-hidden="true"></i><span>Cài đặt</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
	               <ul id="menu-academico-sub">
